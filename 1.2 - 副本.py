...
lay0=[[sg.Text('基于气体热力学进行\n反应计算的小程序',font=("times new roman", 16),size=(20,2))],
      [sg.Text('请选择计算类别',font=("times new roman", 16),size=(20,1))],
      [sg.Button('脉冲推进下的发动机参数计算',font=("times new roman", 12),size=(30,2))],
      [sg.Button('热力学性能计算',font=("times new roman", 12),size=(30,2))],
    ]
win0=sg.Window(title='气体热力学反应计算',size=(300,250), default_element_size=(40, 1), grab_anywhere=True).Layout(lay0)
win1_active=False
wina_active=False
while 1:
    ...
    if event0=='脉冲推进下的发动机参数计算':
        ...
        wina=sg.Window(title='气体热力学反应计算',size=(400,120), default_element_size=(40, 1), grab_anywhere=True).Layout(laya)
        winb_active=False
        winc_active=False
        while 1:
           ...
           if eventa=='确定':
               ...
               winb_active=True
               wina.Hide()       
               winb = sg.Window(title='气体热力学反应计算',size=(500,800), default_element_size=(40, 10), grab_anywhere=True).Layout(layb)
               while 1:
    ...
    if event0=='热力学性能计算':    #此处与1.1版本相同
        ...
        while 1:
           ...
           if event1=='碳氢空气反应模型':
               ...
               str='碳氢空气反应模型'
               win2 = sg.Window(title='气体热力学反应计算',size=(300,270), default_element_size=(40, 10), grab_anywhere=True).Layout(lay2)
           while 1:
