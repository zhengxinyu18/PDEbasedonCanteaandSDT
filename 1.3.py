...
a3=['Blanquart2018.cti','Mevel2017.cti','Mevel2015.cti']
b3=[['CH4/C2H6/C3H8/C2H4/C2H2/C3H6/CH2O/CH3CHO/CH3COCH3/CH3OH/C3H8/C4H2/C4H6/C5H6'],['H2'],[ 'H2','NO2', 'CH4/C2H6/C2H4/C2H2/C3H8/C3H6/C3H4']]
#dictm字典中储存每个反应物的质量
dictm={'H2':2,'CH3CHO':44,'CH4':16,'C2H6':30,'C3H8':44,'C2H4':28,'C2H2':26,'C2H5OH':46,'C3H6':42,'CH2O':30,'CH3CH0':44,'CH3COCH3':58,'CH3OH':32,'C3H4':40,'C4H2':50,'C4H6':54,'C5H6':66,'C6H6':78,'C7H8':92,'C8H8':104,'C8H10':106,'C11H10':142}
#dictn字典储存每个反应物完全反应所需的氧气的物质的量
dictn={'H2':0.5,'CH3CHO':2.5,'CH4':2,'C2H6':3.5,'C3H8':5,'C2H4':3,'C2H2':2.5,'C2H5OH':3,'C3H6':4.5,'CH2O':1,'CH3CH0':2.5,'CH3COCH3':4,'CH3OH':1.5,'C3H4':4,'C4H2':4.5,'C4H6':5.5,'C5H6':6.5,'C6H6':7.5,'C7H8':9,'C8H8':10,'C8H10':10.5,'C11H10':13.5}
...
def pda2 (yqsumn):
    ...
    global q
    q = ''
    if str=='Mevel2017.cti':
        q='H2:1 '
    elif str=='Blanquart2018.cti':
        q=valuesb['fywmulty']+':1 '
    elif str=='Mevel2015.cti':
        if pd2 == 1:
            b3[p].pop(-1)
           ...
           if eventa=='确定':
               ...
               if valuesa[0]==True:
                   ...
                   layb+=[[sg.Text('默认反应机理为:', font=("times new roman", 15),size=(40, 1),)],
                         ...
                         [sg.Text('燃烧反应物：H2', font=("times new roman", 15), size=(40, 1))]]
                   lens=0
               if valuesa[1]==True:
                   pd2=0
                   str='Blanquart2018.cti'
                   p=a3.index('Blanquart2018.cti')
                   lens=len(b3[p])
                   layb+=[[sg.Text('默认反应机理为:', font=("times new roman", 15),size=(40, 1),)],
                         [sg.Text('Blanquart2018.cti', font=("times new roman", 18), size=(40, 1),text_color=('red'))]]
                   for i in range(lens):
                      if b3[p][i].count('/')!=0:
                          code=b3[p][i].split('/')
                          layb+=[
                              [sg.Text('燃烧反应物：', font=("times new roman", 15), size=(15, 1)),sg.InputOptionMenu(code,size=(15,1),key='fywmulty')]
                          ]
                          pd2=1
                          break
                   lens=0
               ...
               while 1:
                   ...
                   if eventb == '预览':
                       try:
                           ...
                           winb['out1'].update('空气流量:{} kg/s'.format(ma))
                       except:
